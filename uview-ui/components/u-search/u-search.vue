	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			<view class="u-icon-wrap">
				<!-- <u-icon class="u-clear-icon" top="0" :size="30" :name="searchIcon" :color="searchIconColor ? searchIconColor : color"></u-icon> -->
			</view>
			<input
				confirm-type="search"
				@blur="blur"
			...
			<view class="u-close-wrap" v-if="keyword && clearabled && focused" @touchstart="clear">
				<u-icon top="0" class="u-clear-icon" name="close-circle-fill" size="34" color="#c0c4cc"></u-icon>
			</view>
		</view>
