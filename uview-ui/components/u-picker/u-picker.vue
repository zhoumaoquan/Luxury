<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="bottom" border-radius="20" :popup="false" v-model="value" length="auto"
	 :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :closeable="true"  :z-index="uZIndex">
		<view class="u-datetime-picker">
			...
			<view class="u-picker-body">
				<picker-view v-if="mode == 'region'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart"
				 @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'time'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart"
				 @pickend="pickend">
				...
				<picker-view v-else-if="mode == 'selector'" :value="valueArr" @change="change" class="u-picker-view" @pickstart="pickstart"
				 @pickend="pickend">
					<picker-view-column>
			...
			<view class="u-picker-btn" @tap.stop="getResult('confirm')">
				<text>确定</text>
			</view>
		</view>
	</u-popup>
